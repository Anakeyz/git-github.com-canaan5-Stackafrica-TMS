...
trait HasWalletMethods
{
     ...
     * @return void
     */
    public function debit(float $amount, Service $service, string $type, string|null $reference = null, string|null $info = null): void
    {
     ...
     * @return void
     */
    public function credit(float $amount, Service $service, string|null $reference = null, string|null $info = null): void
    {
