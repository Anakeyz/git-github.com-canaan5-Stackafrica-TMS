            ...
            {{--<div class="dropdown ml-auto sm:ml-0">
                ...
                <div class="dropdown-menu w-40">
                    <ul class="dropdown-content">
                        <li>
                            <button type="button" class="dropdown-item" data-tw-toggle="modal" data-tw-target="#add-terminal-to-groups">
                                <i data-lucide="file-plus" class="w-4 h-4 mr-2"></i> Add Terminal
                            </button>
                        </li>
                    </ul>
                </div>
