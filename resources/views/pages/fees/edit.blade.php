        ...
        <div class="intro-y col-span-12 sm:col-span-9 md:col-span-8 lg:col-span-7 xl:col-span-6">
            ...
            <form class="intro-y box px-5 py-7 my-form" method="post" action="{{ route('fees.update', $fee) }}">
                ...
                <div class="form-inline mt-6">
                    ...
                    <div class="w-full">
                        <input id="amount" type="number" class="form-control" placeholder="Enter Amount" name="amount" value="{{ old('amount') ?? $fee->amount }}">
                    ...
                    <div class="form">
                        @foreach( $fee->config as $key => $item )
                            <div class="form-inline mt-6">
                                ...
                                <div class="w-full">
                                    <input type="number" class="form-control" name="config[{{$key}}]" value="{{ $item }}">
                                </div>
