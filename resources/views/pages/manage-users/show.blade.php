                                ...
                                {{--<div class="dropdown ml-auto">
                                    ...
                                    <div class="dropdown-menu w-40">
                                        <ul class="dropdown-content">
                                            <li>
                                                <a href="" class="dropdown-item"> <i data-lucide="edit" class="w-4 h-4 mr-2"></i> Edit </a>
                                            </li>
                                            <li>
                                                <a href="" class="dropdown-item"> <i data-lucide="settings" class="w-4 h-4 mr-2"></i> Change Status </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>--}}
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="kyc-level" class="tab-pane" role="tabpanel" aria-labelledby="kyc-level-tab">
                                        ...
                                        <div class="flex justify-center mt-4">
                                            <a href="javascript:;" class="btn btn-sm btn-secondary w-32 mx-2">Update Level</a>
                                            <a href="{{ route('users.kyc-docs.create', $user->id) }}" class="btn btn-sm btn-outline-dark w-32 mx-2">Add/Update Docs</a>
