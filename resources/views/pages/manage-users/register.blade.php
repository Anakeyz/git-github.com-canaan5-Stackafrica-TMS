            ...
            <form class="intro-y box p-5 my-form" method="post" action="{{ route('users.store') }}">
                ...
                <div class="grid grid-cols-12 gap-4 mt-6">
                    ...
                    <div class="col-span-12 md:col-span-4">
                        ...
                        <input type="text" class="form-control" id="state" placeholder="Enter admin's state of residence" aria-label="admin's state of residence"
                ...
                <div class="grid grid-cols-12 gap-4 mt-6">
                    <div class="col-span-12 md:col-span-4">
                        <div x-show="role === 'Agent'" x-transition>
                            <label class="form-label">Super Agent (optional)</label>
                            <select data-placeholder="Select Super Agent" class="tom-select w-full"
